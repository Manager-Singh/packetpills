    ...
    'backend' => [
        'access' => [
            ...
            'preciption-types' => [
                ...
                'main' => 'Preciption Type',
                'view' => 'View Preciption Type',
            ],
            'auto-messages' => [
                'all' => 'All Admin Messages',
                'active' => 'Active Admin Messages',
                'create' => 'Create Admin Message',
                'deactivated' => 'Deactivated Admin Message',
                'deleted' => 'Deleted Admin Message',
                'edit' => 'Edit Admin Message',
                'main' => 'Admin Message',
                'view' => 'View Admin Message',
            ],
            'mail-messages' => [
                'all' => 'All Mail & Messages',
                'active' => 'Active Mail & Messages',
                'create' => 'Create Mail & Message',
                'deactivated' => 'Deactivated Mail & Message',
                'deleted' => 'Deleted Mail & Message',
                'edit' => 'Edit Mail & Message',
                'main' => 'Mail & Message',
                'view' => 'View Mail & Message',
            ],
            'provinces' => [
                'all' => 'All Provinces',
