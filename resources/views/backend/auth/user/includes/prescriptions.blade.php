                        ...
                        <div class="panel-heading" role="tab" id="heading-{{ $prescription->id }}">
                            <h4 class="panel-title">
                                <a role="button" data-toggle="collapse" data-parent="#accordion"
                                    ...
                                    <span class="badge badge-warning" style="right: 29px; position: absolute;">{{ ucfirst($prescription->status) }}</span>
                                    @elseif($prescription->status=="cancelled")
                                    <span class="badge badge-danger" style="right: 29px; position: absolute;">{{ ucfirst($prescription->status) }}</span>
                                    @elseif($prescription->status=="approved")
                                    <span class="badge badge-success" style="right: 29px; position: absolute;">{{ ucfirst($prescription->status) }}</span>
                                    @endif
                                </a>
