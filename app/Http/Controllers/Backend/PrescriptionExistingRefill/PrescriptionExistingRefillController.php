...
class PrescriptionExistingRefillController extends Controller
{
    /**
    ...
    /**
     * @param \App\Repositories\Backend\PrescriptionRefillRepository $prescription
     */
    public function __construct(PrescriptionExistingRefillRepository $repository)
    {
        $this->repository = $repository;
        View::share('js', ['prescription-existing-refill']);
    }
    ...
    {
        return new ViewResponse('backend.prescription-existing-refill.index');
    }
